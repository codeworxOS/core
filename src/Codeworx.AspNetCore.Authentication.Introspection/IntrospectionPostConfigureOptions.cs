...
/// </summary>
public class IntrospectionPostConfigureOptions : IPostConfigureOptions<IntrospectionOptions>
{
    /// <summary>
    ...
    public void PostConfigure(string? name, IntrospectionOptions options)
    {
